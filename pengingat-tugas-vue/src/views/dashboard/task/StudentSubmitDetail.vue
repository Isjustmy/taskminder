      ...
      <div class="w-1/2">
        <div>
          ...
          >
            ...
            <template v-else>
              <img
                v-if="isImageFile(submission.file_path)"
      ...
      <div class="w-1/2">
        <div>
          ...
          <input
            ...
            :value="submission.link || 'Tidak ada link submit'"
            readonly
          />
        </div>
        <div class="flex mt-8">
    ...
    <dialog id="file-modal" class="modal">
      <div class="modal-box">
        <span style="font-size: 14px; cursor: pointer; position: absolute; top: 10px; right: 10px">
          <a :href="task.file_path" target="_blank" class="btn btn-primary mr-5 text-white"
