<template>
  ...
  <body class="bg-gray-50">
              ...
              <div
                ...
                <div class="mt-2 py-2 first:pt-0 last:pb-0">
                  ...
                  <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500"
                    href="#logout-modal" @click.prevent="openLogoutModal()">
              ...
              <dialog id="logout-modal" class="modal">
                <div class="modal-box">
                  ...
                  <div class="modal-action">
                    <form method="dialog">
                      <button v-if="!loading" class="btn btn-success hover:bg-green-300 mr-4" @click.prevent="logout">
                        Ya, Logout
                      </button>
                      <button v-if="loading" aria-disabled="true" class="btn btn-active btn-ghost text-black mr-4">
      ...
      <div class="flex items-center py-4">
        ...
        <ol class="ms-3 flex items-center whitespace-nowrap" aria-label="Breadcrumb">
          <li class="flex items-center text-sm text-gray-800">
            Application Layout
            <svg class="flex-shrink-0 mx-3 overflow-visible size-2.5 text-gray-600" width="16" height="16"
    ...
    <div id="application-sidebar-brand"
      ...
      <div class="px-6">
        <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">Taskminder</a>
      </div>
